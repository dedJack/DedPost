  ...
  return (
    <div className="max-w-7xl m-auto space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Current Earning Rates</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="text-center p-4 bg-purple-50 rounded-lg">
            ...
            <p className={`text-xl font-bold ${dashboard.currentRates?.enableEarnings ? 'text-green-600' : 'text-red-600'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div key={post._id} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  <img
                    ...
                    className={`w-12 h-12 object-cover rounded ${
                      imageLoading[post._id] ? 'animate-pulse bg-gray-200' : ''
                    }`}
                    onError={(e) => {
                      e.target.src = '/default-post.jpg';
                      setImageLoading(prev => ({ ...prev, [post._id]: false }));
                    }}
                    onLoad={() => setImageLoading(prev => ({ ...prev, [post._id]: false }))}
                  />
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500">
                      by @{post.author?.username} • {format(new Date(post.createdAt), 'MMM dd')}
                    </p>
                  </div>
        ...
        {/* Top Earning Posts */}
        <div className="bg-white rounded-lg shadow-md p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Top Earning Posts</h3>
          <div className="space-y-4">
